"""
Vision Transformer (ViT) Training with Checkpoint Support for Kaggle
...
os.makedirs(os.path.join(OUTPUT_DIR, 'results/vit'), exist_ok=True)

print("="*70)
print("VISION TRANSFORMER (ViT) TRAINING (KAGGLE)")
print("="*70)
...
checkpoint_path = os.path.join(CHECKPOINT_DIR, 'vit_latest_checkpoint.pth')
...
for epoch in range(start_epoch, EPOCHS):
    ...
    if val_f1 > best_f1:
        best_f1 = val_f1
        best_model_path = os.path.join(OUTPUT_DIR, 'results/vit/best_model.pth')
    ...
    history_path = os.path.join(OUTPUT_DIR, 'results/vit/history.json')
...
# Save final model
final_model_path = os.path.join(OUTPUT_DIR, 'results/vit/final_model.pth')
